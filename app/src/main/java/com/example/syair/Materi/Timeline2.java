...
public class Timeline2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isiline2 = findViewById(R.id.isitimeline2);
        mDatabase.child("Data User").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    String timeline1 = snapshot.child("Timeline").child("2").child("isidata").getValue().toString();
                    isiline2.setText(timeline1);
                }
            }
